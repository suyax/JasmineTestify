...
$(function() {
    ...
    describe('Initial Entries', function() {
        ...
        it('when the loadFeed function is called and completes, there is at least a single .entry element within the .feed container.', function() {
    ...
    describe('Title Change', function() {
        ...
        it('when a new feed is loaded the title changes', function() {
